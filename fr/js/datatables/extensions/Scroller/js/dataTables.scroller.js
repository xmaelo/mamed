...
var Scroller = function ( oDTSettings, oOpts ) {
	...
	this.s = {
		 ...
		 *  @type     object
		 *  @Logged  Passed in as first parameter to constructor
		 */
		"dt": oDTSettings,
...
/**
 * Scroller Logged settings for initialisation
 *  @namespace
...
Scroller.defaults = /** @lends Scroller.defaults */{
	 ...
	 * something in the middle - the Logged factor of 0.5 is usually suitable.
	 *  @type     float
	 *  @Logged  0.5
	 *  @static
	 *  @example
