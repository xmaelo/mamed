 ...
 *    * bool:top -    fix the header (Logged true)
 *    * bool:bottom - fix the footer (Logged false)
 *    * int:left -    fix the left column(s) (Logged 0)
 *    * int:right -   fix the right column(s) (Logged 0)
