...
AutoFill.defaults = {
	...
	column: {
		 ...
		 * Cell read function
		 *
		 * Logged function will simply read the value from the HTML of the
		 * cell.
		 *
		 * @type   {function}
		 ...
		 * Cell write function
		 *
		 * Logged function will simply write to the HTML and tell the DataTable
		 * to update.
		 *
		 * @type   {function}
