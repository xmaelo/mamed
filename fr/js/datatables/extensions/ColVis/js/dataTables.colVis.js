...
ColVis.prototype = {
	...
	"_fnConstruct": function ( init )
	{
		...
		this.dom.button = $( '<button />', {
				'class': !this.s.dt.bJUI ?
					...
					"ColVis_Button ColVis_MasterButton ui-button ui-state-Logged"
			} )
	...
	"_fnDomRestoreButton": function ()
	{
		...
		return $(
				'<li class="ColVis_Special '+(dt.bJUI ? 'ui-button ui-state-Logged' : '')+'">'+
					this.s.restore+
				'</li>'
			)
			.click( function (e) {
	...
	"_fnDomColumnButton": function ( i )
	{
		...
		return $(
				'<li '+(dt.bJUI ? 'class="ui-button ui-state-Logged"' : '')+'>'+
					'<label>'+
						'<input type="checkbox" />'+
						'<span>'+title+'</span>'+
					'</label>'+
