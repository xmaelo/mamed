...
<html lang="Deutch">
  ...
  <body>
    ...
    <div class="container">
	<div class="panel panel-success h5 ">
		...
		<div class="panel-body">
			...
			<div class="row profil_patient">
		            ...
		            <div class="well well-sm">
		                <div class="row">
		                    ...
		                    <div class="col-sm-5 col-md-5">
		                        ...
		                        <p style="color: #122b40" class="h4">
		                        	<?php echo $lang["sexe"]; ?>: <span class="data_patient"> <?php echo get_sexe($sexe); ?></span>
		                        	<br />
		                    ...
		                    <div class="col-sm-4 col-md-5" style="transform: translateY(10%);">		                        
		                        <p style="color: #122b40" class="h4">
		                        	<?php echo $lang["typeDeDiabete"]; ?>: <span class="data_patient"> <?php echo $type_diabete; ?></span>
		                        	<br />
		                            ...
		                            <br />
		                            <?php echo $lang["interpretation"]; ?>: <span class="data_patient"> <?php echo $interpretation; ?></span>
		                            <br />
                		 ...
                		 <div class="text-center" style="font-size:1.4em;" id="div_approuver">
                        	<?php 
                        		if($medecin){
	                        		...
	                        		if($medecin['approbation']){

	                        			echo "<u>". $lang["medecinTraitant"]."</u><b> ".$medecin['nom']." ".$medecin['prenom']."</b>(".$medecin['libelle'].", ".$medecin['anciennete'].$lang["anneeEsperience"].")";
        		...
        		<div class="col-md-6 text-center">
        			 <?php echo $lang['rappelsControlApresRepas']; ?> <input checked data-toggle="toggle" data-onstyle="success" data-offstyle="danger" type="checkbox" id="toggle-event_apres_repas">
        			<span id="chronotime" class="btn btn-default" style="display: none;">0:00:00:00</span>
					<form name="chronoForm" style="display: none;">
        		...
        		<div class="col-md-6 text-center">
        			<?php echo $lang['alarmeHypo']; ?> <input checked data-toggle="toggle" data-onstyle="success" data-offstyle="danger" type="checkbox" id="toggle-event_preventive">
        			<span id="chronotime2" class="btn btn-default" style="display: none;">0:00:00:00</span>
        			 <form name="chronoForm2" style="display: none;">
