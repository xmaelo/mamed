	...
	if (isset($_GET['id'])){
		...
		?>
			<div class="alert alert-success alert-dismissible" role="alert">
			  ...
			  <strong>Info!</strong> Données suppimées avec succès.
			</div>
			<?php 
		}else {
			?>
		...
		if ($numrows>0){
			...
			?>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<div class="col-md-2 col-md-2 col-sm-6 col-xs-12 thumb text-center ng-scope" ng-repeat="item in records">
						  <a class="thumbnail" href="producto.php?id=<?php echo $id_producto;?>">
							  ...
							  <img class="img-responsive" src="img/stock-mobile.png" alt="<?php echo $nombre_producto;?>">
						  </a>
						  <span class="thumb-code ng-binding"><strong><?php echo $codigo_producto;?></strong></span>
						  <span class="thumb-name"><?php echo $nombre_producto;?></span>
					</div>
					<?php
					if ($nums%6==0){
