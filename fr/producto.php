<?php
	...
	if (isset($_POST['reference']) and isset($_POST['quantity'])){
		...
		$nota="enfants ajoutés par $firstname";
	...
	if (isset($_POST['reference_remove']) and isset($_POST['quantity_remove'])){
		...
		$user_id=$_SESSION['user_id'];
		$firstname=$_SESSION['firstname'];
		$nota="enfants retirés par $firstname";
		$fecha=date("Y-m-d H:i:s");
		guardar_historial($id_producto,$user_id,$fecha,$nota,$reference,$quantity);
            ...
            <div class="row">
              <div class="col-sm-4 col-sm-offset-2 text-center">
				 <img class="item-img img-responsive" src="img/stock.png" alt=""> 
				  <br>
                    <a href="#" class="btn btn-danger" onclick="eliminar('<?php echo $row['id_producto'];?>')" title="Eliminar"> <i class="fa fa-trash"></i> Supprimer </a> 
					<a href="#myModal2" data-toggle="modal" data-codigo='<?php echo $row['codigo_producto'];?>' data-nombre='<?php echo $row['nombre_producto'];?>' data-categoria='<?php echo $row['id_categoria']?>' data-precio='<?php echo $row['precio_producto']?>' data-stock='<?php echo $row['stock'];?>' data-id='<?php echo $row['id_producto'];?>' class="btn btn-info" title="Editar"> <i class="glyphicon glyphicon-pencil"></i> Editer </a>	
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
					...
					<div class="col-sm-12">
                      <span class="current-stock"> Prix </span>
                    </div>
					<div class="col-sm-12">
                  ...
                  <div class="row">
                    <?php
						...
						<div class="alert alert-success alert-dismissible" role="alert">
						  ...
						  <strong>Info!</strong> Données enregistrées. 
						</div>	
							<?php
						}
						if (isset($error)){
						...
						<div class="alert alert-danger alert-dismissible" role="alert">
						  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						  <strong>Erreur!</strong> Il y a un chmurtz.
						</div>	
							<?php
						}
					?>	
					 <table class='table table-bordered'>
						<tr>
							<th class='text-center' colspan=5 >HISTORIQUE</th>
						</tr>
						<tr>
							<td>Date</td>
							<td>Heure</td>
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			...
			data: parametros,
			 beforeSend: function(objeto){
				$("#resultados_ajax2").html("Chargement...");
			  },
  ...
  event.preventDefault();
	...
	function eliminar (id){
		var q= $("#q").val();
		if (confirm("Voulez vous supprimer ce enfant ?")){	
